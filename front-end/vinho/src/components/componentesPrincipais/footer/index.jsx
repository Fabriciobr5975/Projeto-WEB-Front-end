...
export default function Footer(props) {
  ...
  const [habilitarSecao, setHabilitarSecao] = useState(false);
  const [mostrarSecao, setMostrarSecao] = useState(false);

  const referenciaSecao = useRef(null);

  useEffect(() => {
    if (habilitarSecao && referenciaSecao.current) {
      referenciaSecao.current.scrollIntoView({ behavior: "smooth" });
    } else {
      setTimeout(() => setMostrarSecao(false), 300);
    }
  }, [habilitarSecao]);
    ...
    <footer className="footer">
      ...
      <div className="direitos-reservados">
        ...
        <i
          ...
          id="habilitar-informacoes-adicionais"
          onClick={() => {
            setHabilitarSecao((prev) => !prev);
            setMostrarSecao(true);
          }}
        ></i>
        {mostrarSecao && (
          <div
            ref={referenciaSecao}
            className={`informacoes-adicionais-footer ${
              habilitarSecao ? "fade-in" : "fade-out"
            }`}
          >
            <p className="descricao-projeto-footer">
              Este site foi criado como parte de um projeto acadêmico. Nenhuma
              transação comercial real é realizada.
            </p>
            <div className="integrantes-projeto-viana-vinhos">
              <h4>Um projeto realizado por:</h4>
              <ul className="lista-integrantes-footer">
                <li>
                  <i class="fa-brands fa-github"></i>
                  <a
                    href="https://github.com/Fabriciobr5975"
                    target="_blank"
                ...
                <li>
                  <i class="fa-brands fa-github"></i>
                  <a
                    href="https://github.com/geovannanovais"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Geovanna Novais
                ...
                <li>
                  <i class="fa-brands fa-github"></i>
                  <a
                    href="https://github.com/MarcusVPRocha"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Marcus Vinícius Pereira Rocha
                  </a>
                </li>
                <li>
                  <i class="fa-brands fa-github"></i>
                  <a
                    href="https://github.com/Ruanlv "
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Ruan Lopes Viana
