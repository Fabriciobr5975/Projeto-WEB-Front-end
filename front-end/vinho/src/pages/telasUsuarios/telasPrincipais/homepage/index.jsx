...
import Vinho from "../../../../components/componentesPrincipais/vinho";
import Disclaimer from "../../../../components/componentesAuxiliares/disclaimer";
      ...
      <TelaCarregamento tempo={250}>
        ...
        <section className="secao-sobre-nos">
          ...
          <div className="informacao-sobre-nos">
            ...
            <hr />
            <p>
              A empresa <strong>Viana Vinhos Finos</strong> foi criada em 1992.
              Representante Ronilton de Melo Viana.
            </p>
            <p>
              A empresa tem como objetivo atender as pessoas que apreciam um bom
              vinho. Nossos parceiros profissionais:{" "}
              <strong>Vinícola Gões</strong> e{" "}
              <strong>Vinícola XV de Novembro</strong>.
            </p>
            <p>
