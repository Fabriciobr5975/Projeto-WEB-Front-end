        ...
        <div className="recibo-pedido">
          ...
          <div className="mensagem-recibo">
            <div className="mensagem-agradecimento">
              <p>
                Agradecemos pela preferência! Enviaremos um e-mail com todas as
                informações deste pedido para o e-mail cadastrado em sua conta.
              </p>
            </div>

            <div className="mensagem-final">
              <p>
                Lembre-se que você também pode acompanhar seu pedido através da
                sua conta
              </p>
            </div>
          </div>
