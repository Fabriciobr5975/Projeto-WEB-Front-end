        ...
        <div className="informacoes-sobre-nos">
          <div className="informacoes">
            ...
            <div className="texto">
              ...
              <p>
                ...
                promocionais. Descubra rótulos exclusivos e experiências únicas
                na loja que é referência entre os amantes do bom vinho.
              </p>
            </div>
          </div>
          ...
          <div className="informacoes-adicionais">
            ...
            <div className="visao">
              ...
              <h2>Visão</h2>
              <p>
                Ser o principal destino para os amantes do vinho, oferecendo uma
                experiência completa que une conhecimento, prazer e
                acessibilidade
              </p>
            </div>
            ...
            <div className="valores">
              ...
              <h2>Valores</h2>
              <p>
                <strong>Paixão pelo Vinho:</strong> Compartilhamos o entusiasmo
                e a curiosidade que nos inspiram a explorar o mundo do vinho e a
                transmitir esse conhecimento aos nossos clientes.
              </p>
              <p>
                <strong>Qualidade e Autenticidade:</strong> Priorizamos a
                excelência em todos os aspectos desde a seleção dos vinhos até o
                atendimento personalizado, garantindo uma experiência autêntica
                e memorável.
              </p>
            </div>
          </div>
